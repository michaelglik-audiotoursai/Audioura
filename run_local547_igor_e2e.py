...
TEST_USER = "ITEST-LOCAL524-IGOR"   # dedicated id; never a real user
...
STOPS = [
    "the Sargent Murals",
    "the Liberty Bowl by Paul Revere",
    "Watson and the Shark by Copley",
]
LOCATION = (
    "Museum of Fine Arts, Boston, with a stop at the Sargent Murals "
    "and a stop at the Liberty Bowl by Paul Revere "
    "and a stop at Watson and the Shark by Copley"
)
