#!/usr/bin/env python3
"""MUSEUM5: R1 fragment fix + Description: label gate + R7 orientation (MUSEUM5).
...
print("=" * 70)
print("MUSEUM5: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (MUSEUM5)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after MUSEUM5 patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [MUSEUM5] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL281_museum_5stop_museum5.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_MUSEUM5_LOCAL281_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_MUSEUM5.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_MUSEUM5.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Museum 5-stop (MUSEUM5)\n\n")
    f.write("> ### What changed: MUSEUM5 — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (MUSEUM5)\n\n")
    ...
    f.write("| Metric | Round 12 | Museum 5-stop |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_MUSEUM5.md")
