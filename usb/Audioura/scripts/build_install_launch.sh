#!/bin/bash
# BUILD, INSTALL, LAUNCH (generic — replaces build_install_launch_a28.sh)
...
#
# Originally created by Claude AI Path A on 2026-04-29 16:49 as build_install_launch_a28.sh
# Renamed to build_install_launch.sh (version-neutral) from A#33 onward
# build_install_launch_a28.sh kept as history — do not reuse
#
...
PROJECT_DIR="$HOME/Development/Audioura-build/audio_tour_app"
