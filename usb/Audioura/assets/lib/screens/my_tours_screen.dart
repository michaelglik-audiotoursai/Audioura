...
class _MyToursScreenState extends State<MyToursScreen> {
  ...
  Future<void> _loadTours() async {
    ...
    // Re-read healed paths so _tours has correct container-safe paths
  ...
  // A#56: heals stale iOS container UUID in saved tour paths after app reinstall
  Future<void> _healTourPaths() async {
    ...
    for (final raw in savedRaw) {
      try {
        ...
        // Extract relative part: everything from '/tours/' onward
