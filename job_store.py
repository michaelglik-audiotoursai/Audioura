"""
Job Store — Database-backed replacement for ACTIVE_JOBS in-memory dict.
===========================================================================
...
container than the one that created the job → 404.
...
def get_job_store(service_name='unknown'):
    ...
    JOB_STORE_MODE:
      'memory' (default) — in-memory dict (backwards compatible, local Docker)
      'database' — PostgreSQL job_status table (Cloud Run multi-instance safe)
    """
