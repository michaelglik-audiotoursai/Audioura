@echo off
echo === Building Voice Control Mic Button Only APK (Version 1.0.0+114) ===
...
echo Version: 1.0.0+114
echo.
echo Voice Control Features:
echo - Tap MIC button in tour player to activate voice listening
...
echo - No hardware button dependencies - mic button only
pause