...
docker logs development_user-api-2_1 --tail 20
...
docker exec -it development_postgres-2_1 psql -U admin -d audiotours -c "SELECT id, tour_id, request_string, status, finished_at FROM tour_requests WHERE tour_id='tour_1981933a718'"