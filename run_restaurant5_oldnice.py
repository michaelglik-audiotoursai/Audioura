#!/usr/bin/env python3
"""RESTAURANT3: R1 fragment fix + Description: label gate + R7 orientation (RESTAURANT3).
...
print("=" * 70)
print("RESTAURANT3: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (RESTAURANT3)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after RESTAURANT3 patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [RESTAURANT3] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL311_restaurant_5stop_oldnice.txt")
...
for gen_attempt in range(1, MAX_GEN_ATTEMPTS + 1):
    ...
    try:
        result = generate_tour_text(
            location="restaurant tour in Old Town, Nice, France",
...
_tour_name_unique = f"RIVIERA_2STOP_RESTAURANT3_LOCAL282_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_RESTAURANT3.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_RESTAURANT3.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Restaurant 3-stop (RESTAURANT3)\n\n")
    f.write("> ### What changed: RESTAURANT3 — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (RESTAURANT3)\n\n")
    ...
    f.write("| Metric | Round 12 | Restaurant 3-stop |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_RESTAURANT3.md")
