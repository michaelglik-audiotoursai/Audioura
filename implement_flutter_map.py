...
def main():
    ...
    # Update pubspec.yaml to replace mapbox_gl with flutter_map
    pubspec_updates = '''
# Replace mapbox_gl with flutter_map dependencies
dependencies:
  flutter:
    sdk: flutter
  flutter_map: ^6.1.0
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    print("\nNext steps:")
    print("1. Update pubspec.yaml with flutter_map dependencies")
    print("2. Replace your existing home page with this implementation")
    print("3. Add location permissions to android/app/src/main/AndroidManifest.xml")
    print("4. Test the map functionality")
