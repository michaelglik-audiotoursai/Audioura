...
def decrypt_credentials(mobile_public_key_hex, server_private_key, encrypted_username_b64, encrypted_password_b64):
    ...
    try:
        ...
        try:
            ...
            if len(encrypted_username) >= 16:
                iv_username = encrypted_username[:16]
                ciphertext_username = encrypted_username[16:]
                
                if len(ciphertext_username) % 16 == 0:  # Proper padding
                    ...
                    decrypted_username = f"INVALID_PADDING_LENGTH_{len(ciphertext_username)}"
            else:
                decrypted_username = "INVALID_DATA_TOO_SHORT"
        except Exception as e:
            decrypted_username = f"DECRYPT_ERROR: {str(e)}"
        ...
        try:
            ...
            if len(encrypted_password) >= 16:
                ...
                if len(ciphertext_password) % 16 == 0:  # Proper padding
                    ...
                    decrypted_password = f"INVALID_PADDING_LENGTH_{len(ciphertext_password)}"
            else:
                decrypted_password = "INVALID_DATA_TOO_SHORT"
        except Exception as e:
            decrypted_password = f"DECRYPT_ERROR: {str(e)}"
        
        return decrypted_username, decrypted_password
        
    except Exception as e:
        return f"CRYPTO_ERROR: {str(e)}", f"CRYPTO_ERROR: {str(e)}"

if __name__ == "__main__":
    # Data from mobile app
    mobile_public_key = ""
    ...
    # Show data lengths for debugging
    username_bytes = base64.b64decode(encrypted_username)
    password_bytes = base64.b64decode(encrypted_password)
    print(f"\nData lengths:")
    print(f"Username: {len(username_bytes)} bytes (IV: 16, Ciphertext: {len(username_bytes)-16})")
    print(f"Password: {len(password_bytes)} bytes (IV: 16, Ciphertext: {len(password_bytes)-16})")