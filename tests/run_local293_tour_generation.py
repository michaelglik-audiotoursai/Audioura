#!/usr/bin/env python3
"""LOCAL-293: Generate one 8-stop Riviera tour to confirm delivery has not regressed.

Acceptance: 8 stops delivered (matching LOCAL-290's 8/8 result).
...
tour_type = "walking"
total_stops = 8
output_file = os.path.join(TOURS_DIR, "LOCAL293_8stop_riviera.txt")
