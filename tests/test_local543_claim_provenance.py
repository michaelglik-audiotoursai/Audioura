...
from tour_quality import score_tour, REQUIRED_CLEAN, _find_unsourced_person_events
...
def test_unsourced_person_event_is_required_clean():
    assert 'unsourced_person_event' in REQUIRED_CLEAN
...
def test_survey_covers_48_files():
