#!/usr/bin/env python3
"""ROUND21: R1 fragment fix + Description: label gate + R7 orientation (ROUND21).
...
print("=" * 70)
print("ROUND21: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (ROUND21)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after ROUND21 patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [ROUND21] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL268_riviera_2stop_round21.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND21_LOCAL268_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND21.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND21.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 21 (ROUND21)\n\n")
    f.write("> ### What changed: ROUND21 — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (ROUND21)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 21 |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND21.md")
