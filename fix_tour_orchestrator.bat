@echo off
REM Script to fix the tour orchestrator service

echo.
echo ===== Fixing Tour Orchestrator Service =====
echo.
echo This script will:
echo 1. Update the tour orchestrator to properly call the coordinates-fromai service
echo 2. Add more detailed logging to both services
echo 3. Update the existing tour for Simsbury Free Library with coordinates
echo.
echo Press any key to continue or Ctrl+C to cancel...
pause > nul

python fix_tour_orchestrator.py
