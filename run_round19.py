#!/usr/bin/env python3
"""ROUND19: R1 fragment fix + Description: label gate + R7 orientation (ROUND19).
...
print("=" * 70)
print("ROUND19: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (ROUND19)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after ROUND19 patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [ROUND19] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL266_riviera_2stop_round19.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND19_LOCAL266_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND19.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND19.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 19 (ROUND19)\n\n")
    f.write("> ### What changed: ROUND19 — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (ROUND19)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 19 |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND19.md")
