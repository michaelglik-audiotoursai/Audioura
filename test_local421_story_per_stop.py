...
STOP1_GOOD_DESCRIPTION = (
    ...
    "for chromolithography at this scale. Boris Fridman, a Boston-based collector "
    "who assembled one of the largest private holdings of livres d'artiste in "
    "New England, donated this work to the MFA. Fridman's gift brought the "
