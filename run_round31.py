#!/usr/bin/env python3
"""ROUND31_8STOP: R1 fragment fix + Description: label gate + R7 orientation (ROUND31_8STOP).
...
print("=" * 70)
print("ROUND31_8STOP: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (ROUND31_8STOP)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after ROUND31_8STOP patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [ROUND31_8STOP] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL277_riviera_2stop_round31_8stop.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND31_8STOP_LOCAL277_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND31_8STOP.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND31_8STOP.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 31 (8 stops) (ROUND31_8STOP)\n\n")
    f.write("> ### What changed: ROUND31_8STOP — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (ROUND31_8STOP)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 31 (8 stops) |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND31_8STOP.md")
