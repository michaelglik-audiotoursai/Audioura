...
def decrypt_credentials():
    # From the logs - the actual mobile public key used in submission
    ...
    # From the logs - the actual encrypted data sent
    ...
    print("=== DECRYPTING WITH CORRECT MOBILE PUBLIC KEY FROM LOGS ===")
    
    # Calculate shared secret using mobile app method
    ...
    # Convert shared secret to bytes using mobile app's exact method
    shared_secret_bytes = big_int_to_full_bytes(shared_secret)
    
    # Derive AES key using mobile app method
