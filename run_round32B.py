#!/usr/bin/env python3
"""ROUND32B: R1 fragment fix + Description: label gate + R7 orientation (ROUND32B).
...
print("=" * 70)
print("ROUND32B: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (ROUND32B)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after ROUND32B patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [ROUND32B] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL278B_riviera_2stop_round32B.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND32B_LOCAL278B_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND32B.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND32B.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 32B (ROUND32B)\n\n")
    f.write("> ### What changed: ROUND32B — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (ROUND32B)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 32B |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND32B.md")
