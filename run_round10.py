#!/usr/bin/env python3
"""run_round10.py — the first generation the gates can actually stop.
...
OUT = os.path.join(HERE, 'TOURS_FOR_REVIEW', 'round10')
...
with open(os.path.join(OUT, 'ROUND10_SUMMARY.json'), 'w') as f:
