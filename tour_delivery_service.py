#!/usr/bin/env python3
"""
Tour Delivery Service - Serves tours from PostgreSQL database to mobile app
"""
import os
import sys
import json
...
def health_check():
    ...
    return jsonify({"status": "healthy", "service": "tour_delivery"})
...
if __name__ == '__main__':
    print("Starting Tour Delivery Service...")
    print("Endpoints:")
