#!/usr/bin/env python3
"""ROUND13: R1 fragment fix + Description: label gate + R7 orientation (LOCAL-256).
...
print("=" * 70)
print("ROUND13: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (LOCAL-256)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after LOCAL-256 patterns)
# ======================================================================
print("\n" + "=" * 70)
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL256_riviera_2stop_round13.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND13_LOCAL256_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND13.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND13.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 13 (ROUND13)\n\n")
    f.write("> ### What changed: LOCAL-256 — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (LOCAL-256)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 13 |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND13.md")
