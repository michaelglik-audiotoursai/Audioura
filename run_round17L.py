#!/usr/bin/env python3
"""ROUND17L: R1 fragment fix + Description: label gate + R7 orientation (ROUND17L).
...
print("=" * 70)
print("ROUND17L: R1 FRAGMENT FIX + DESCRIPTION LABEL + R7 ORIENTATION (ROUND17L)")
print("=" * 70)
...
# ======================================================================
# STEP 0: CORPUS-WIDE R7 BASELINE (before + after ROUND17L patterns)
# ======================================================================
print("\n" + "=" * 70)
...
# [ROUND17L] Every gate ON at Michael's request — including the subject routine,
...
output_file = os.path.join(PROJECT_ROOT, "tours", "LOCAL264_riviera_2stop_round17L.txt")
...
_tour_name_unique = f"RIVIERA_2STOP_ROUND17L_LOCAL264_{int(time.time())}"
cur.execute("""
...
# ======================================================================
print("\n" + "=" * 70)
print("STEP 5: WRITE RIVIERA_2STOP_ROUND17L.md")
print("=" * 70)

word_count = len(tour_text.split())

md_path = os.path.join(PROJECT_ROOT, "RIVIERA_2STOP_ROUND17L.md")
with open(md_path, 'w') as f:
    f.write("# French Riviera Cycling Tour - 2 Stops, Round 17L (ROUND17L)\n\n")
    f.write("> ### What changed: ROUND17L — R1 fragment fix, Description: gate, R7 orientation\n>\n")
    ...
    f.write("## R7 Corpus-Wide Before/After (ROUND17L)\n\n")
    ...
    f.write("| Metric | Round 12 | Round 17L |\n|---|---|---|\n")
...
print("=" * 70)
print(f"  Artifact: RIVIERA_2STOP_ROUND17L.md")
